...
- o candidato padrão é prata neutro sólido `#D8E1E8`, configurável globalmente ou apenas para o GCD;
...
O crescimento da barra comunica aproximação do estado ready. A cor é decorativa e nunca substitui o comprimento como fonte de progresso. O prata evita competir com azul estrutural/buff, ciano do cast, verde positivo, âmbar de atenção e vermelho de debuff/urgência. A seleção final continua sob revisão em `UI-DESIGN-010`.
