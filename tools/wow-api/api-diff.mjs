...
const sourcePath = /^Interface\/AddOns\/(?:Blizzard_APIDocumentationGenerated\/[A-Za-z0-9]+|Blizzard_ActionBar\/Shared\/(?:ActionButton|ActionButtonUtil)|Blizzard_SharedXML\/FontableFrameMixin)\.lua$/u;
