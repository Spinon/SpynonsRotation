...
const requiredFiles = [
  ...
  "addon/Rotation/Program.lua",
  "addon/Rotation/StateReader.lua",
  "addon/Rotation/RecommendationEngine.lua",
  "addon/Classes/Shaman/Enhancement/RotationData.lua",
  "docs/architecture/RECOMMENDATION_ENGINE.md",
  "addon/Compat/Media.lua",
  "addon/Compat/Console.lua",
  "addon/Compat/ClientPolicy.lua",
  "tools/wow-api/api-diff.mjs",
  "tools/wow-api/sources.json",
  "docs/architecture/API_DIFF.md",
  "addon/Core/InGameHarness.lua",
  "addon/Core/ContextDetector.lua",
  "addon/Core/ContextController.lua",
  "addon/Compat/Context.lua",
  "tests/unit/context_detector_spec.lua",
  "docs/architecture/CONTEXT_DETECTOR.md",
  "tests/unit/in_game_harness_spec.lua",
  "docs/project/RETAIL_SMOKE.md",
  "addon/UI/Queue.lua",
  "addon/UI/QueueEditor.lua",
  "tests/unit/hud_editor_spec.lua",
  "docs/architecture/HUD_EDITOR.md",
  "addon/Config/Settings.lua",
  "addon/Skins/Default.lua",
  "addon/Skins/Contract.lua",
  "addon/Skins/Registry.lua",
  "addon/Skins/PublicAPI.lua",
  "examples/SpynonSkin_Example/SpynonSkin_Example.toc",
  "examples/SpynonSkin_Example/Skin.lua",
  "tests/unit/external_skins_spec.lua",
  "docs/architecture/EXTERNAL_SKINS.md",
  "tests/unit/skins_spec.lua",
  "docs/architecture/SKINS.md",
  "addon/Config/History.lua",
  "addon/Config/HistoryBinding.lua",
  ...
  "docs/architecture/BASIC_CONFIG.md",
  "addon/Core/Contracts/Indicator.lua",
  "addon/Core/IndicatorEngine.lua",
  "addon/UI/AuraIndicators.lua",
  "tests/unit/indicators_spec.lua",
  "docs/architecture/AURA_INDICATORS.md",
  ...
  "docs/architecture/DEMO_MODE.md",
  "addon/Compat/Cooldowns.lua",
  "addon/UI/CooldownOverlay.lua",
  "docs/architecture/COOLDOWN_OVERLAYS.md",
  "tests/unit/cooldown_overlay_spec.lua",
  ...
  "addon/UI/QueueController.lua",
  "docs/architecture/QUEUE_UI.md",
  "tests/unit/queue_spec.lua",
  "tests/unit/recommendation_engine_spec.lua",
...
const volatileApiPatterns = [
  ...
  { name: "C_Item", pattern: /\bC_Item\b/u },
